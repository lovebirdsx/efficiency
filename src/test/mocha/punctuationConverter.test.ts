...
describe('Punctuation Converter Tests', function () {
    before(async function () {
        await fs.mkdir("tmp", { recursive: true });
    });

    describe('To English Test', function () {
        it('should convert Chinese punctuation to English', function () {
    ...
    describe('To Chinese Test', function () {
        it('should convert English punctuation to Chinese', function () {
    ...
    describe('To English File Test', function () {
        it('should convert punctuation in a file to English', async function () {
    ...
    describe('To Chinese File Test', function () {
        it('should convert punctuation in a file to Chinese', async function () {
